---
epoch: 1776024408350
modelKey: gemma-4-26b-a4b|lm-studio
tags:
  - copilot-conversation
topic: Designing Spell-Specifications
---

**user**: Can you read through the both document and write a document title 'Spell-Specifications' that summarises how I want spells to work
[Context: Notes: llm-planner/Rune Spell System Design - 2026-04-12 11.24.md, llm-planner/Spells.md]
[Timestamp: 2026/04/12 21:06:48]

**ai**: # Spell-Specifications

This document outlines the technical and mechanical specifications for the rune-based spell casting system. The design focuses on a high-stakes, data-driven approach where player input directly impacts resource management and spell outcomes.

---

## 1. Core Gameplay Loop
The game is a **2D top-down action RPG** centered around a wizard character. The primary mechanic involves typing sequences of runes to manifest spells.
