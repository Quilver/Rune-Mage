# [Rune Mage] Knowledge Base — Schema
...
This is an LLM-maintained knowledge base on [Rune Mage]. The LLM writes and maintains all files under `wiki/`. The human curates raw sources and directs queries. The human never edits wiki files directly.
